...
urlpatterns = [
    ...
    path('send-match-request/<str:username>/', views.send_match_request, name='send_match_request'),
    path('matching/<str:username>/', views.user_matching, name='user_matching'),
]